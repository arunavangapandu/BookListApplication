...
public class QueryUtils {
     ...
     */
    private static List<Book> extractBookFromJson(String bookListJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // get the book title from the volumeInfo object.
                String bookTitle = volumeInfo.getString("title");

                // get the authors of the book from the book Info object.
                JSONArray bookAuthors =  volumeInfo.getJSONArray("authors");

                String authorName = null;

                for(int j= 0; j < bookAuthors.length(); j++){
                    authorName = bookAuthors.getString(j);
                }
                ...
                Book book = new Book(bookId, bookTitle, authorName, publisher, previewLink);
